...
Para dejar documentado el proceso de evaluación, se planteó una prueba piloto de usabilidad con cinco perfiles de usuario y tareas representativas, tomando como referencia trabajos recientes que evalúan la usabilidad de videojuegos serios sobre bullying y cyberbullying \cite{martel2025}. Por limitaciones de tiempo y disponibilidad, los resultados se registran como una simulación controlada basada en el recorrido real del prototipo y en los puntos de fricción observados por el equipo durante las pruebas internas.
