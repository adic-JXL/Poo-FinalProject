...
Las Figuras \ref{fig:menu} a \ref{fig:puzzle-eco} muestran evidencias visuales del prototipo. \textbf{[COMPLETAR]} Para que estas figuras aparezcan al compilar, se deben guardar las capturas en la carpeta \textit{docs/figuras} con los nombres indicados en cada bloque.
...
\begin{figure}[t]
\centering
\IfFileExists{figuras/controles.png}{\includegraphics[width=\linewidth]{figuras/controles.png}}{\placeholderfigure{3.1cm}{Guardar captura como figuras/controles.png}}
...
\begin{figure}[t]
\centering
\IfFileExists{figuras/puzzle_salon.png}{\includegraphics[width=\linewidth]{figuras/puzzle_salon.png}}{\placeholderfigure{3.1cm}{Guardar captura como figuras/puzzle\_salon.png}}
...
\begin{figure}[t]
\centering
\IfFileExists{figuras/puzzle_eco.png}{\includegraphics[width=\linewidth]{figuras/puzzle_eco.png}}{\placeholderfigure{3.1cm}{Guardar captura como figuras/puzzle\_eco.png}}
...
\centering
\begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}p{1.4cm}>{\raggedright\arraybackslash}p{2.4cm}>{\raggedright\arraybackslash}p{2.4cm}X}
\toprule
\textbf{Usuario} & \textbf{Tareas completadas} & \textbf{Dificultad percibida} & \textbf{Observaciones principales} \\
\midrule
U1 & \textbf{[COMPLETAR]} & \textbf{[COMPLETAR]} & \textbf{[COMPLETAR]} \\
U2 & \textbf{[COMPLETAR]} & \textbf{[COMPLETAR]} & \textbf{[COMPLETAR]} \\
U3 & \textbf{[COMPLETAR]} & \textbf{[COMPLETAR]} & \textbf{[COMPLETAR]} \\
U4 & \textbf{[COMPLETAR]} & \textbf{[COMPLETAR]} & \textbf{[COMPLETAR]} \\
U5 & \textbf{[COMPLETAR]} & \textbf{[COMPLETAR]} & \textbf{[COMPLETAR]} \\
\bottomrule
\end{tabularx}
\end{table*}
