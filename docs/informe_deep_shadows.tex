...
\begin{itemize}
    ...
    \item Se incluyeron elementos de accesibilidad, usabilidad e inclusión, como selector de \textit{skin}, filtros de color para daltonismo, control de volumen, resolución, modo de pantalla, intensidad de sacudida de cámara y una escena de controles.
\end{itemize}
...
Pérez et al. exploraron el uso de juegos serios y modelos probabilísticos para estudiar cyberbullying, tanto mediante redes bayesianas como mediante generación de datos sintéticos para analizar decisiones de jugadores \cite{perez2023,perez2024}. Estos trabajos son relevantes porque muestran que los videojuegos pueden servir no solo como recurso educativo, sino también como medio para observar patrones de respuesta ante situaciones de acoso.
...
Los requisitos no funcionales se organizaron usando categorías de calidad inspiradas en el modelo FURPS: funcionalidad, usabilidad, confiabilidad, rendimiento y soporte. Estas categorías permiten describir cómo debe comportarse el sistema más allá de sus funciones principales, lo cual coincide con la noción reciente de requisitos de calidad en ingeniería de software \cite{olsson2022}. La Tabla \ref{tab:furps} presenta la aplicación del modelo al proyecto.
...
El equipo mínimo usado por el grupo para ejecutar el prototipo fue un portátil DELL con nombre de dispositivo ManuDell, procesador 13th Gen Intel(R) Core(TM) i5-1335U a 1.30 GHz, 16.0 GB de RAM instalada, tarjeta gráfica Intel(R) Iris(R) Xe Graphics, almacenamiento con 422 GB de 477 GB usados y sistema operativo de 64 bits basado en x64. La medición de rendimiento queda preparada para completarse posteriormente: \textbf{FPS promedio observado: 120 FPS}.

\subsection{Componente Inclusivo}
El componente inclusivo del prototipo incorpora un selector de \textit{skin} para que el jugador pueda elegir entre dos variantes del personaje principal: una masculina y una femenina. Esta selección no modifica las mecánicas de juego, la dificultad ni la progresión, sino que permite una representación básica del jugador dentro de la experiencia. La evidencia visual de este selector se mostrará durante la presentación del proyecto, por lo que no se incluye una captura adicional dentro del informe.

Además del selector de \textit{skin}, el juego integra opciones de accesibilidad visual y comodidad de interacción. El menú de opciones permite seleccionar filtros de color para distintos tipos de daltonismo, modificar el volumen, probar sonido, ajustar resolución, cambiar modo de pantalla y regular la sacudida de cámara. Adicionalmente, el juego presenta instrucciones visuales mediante el manual de usuario, mensajes dentro del HUD y textos de retroalimentación en puzzles.
...
El prototipo actual incluye un menú principal, menú de opciones, manual de usuario, selector de partidas con tres slots, selector de \textit{skin} con personaje masculino y femenino, escena de juego principal, HUD, jugador, puzzles, puertas, llave, checkpoints, enemigos, sistema de diálogos, segundo mundo y elementos de accesibilidad. La Tabla \ref{tab:resultados-poo} resume evidencias de programación orientada a objetos observadas en el proyecto.
...
Las Figuras \ref{fig:menu} a \ref{fig:evidencias-avanzadas} muestran evidencias visuales del prototipo, incluyendo menús, objetivos, controles, sistema de partidas, escenario inicial, puzzle ejemplar, uso de gafas, jefes, segundo mundo y final del recorrido.
...
\smallskip
\footnotesize (a) Uso de las gafas para ampliar la visión y revelar rutas del primer mundo.
\end{minipage}
\hfill
\begin{minipage}{0.48\textwidth}
\centering
...
\smallskip
\footnotesize (b) Primer jefe del prototipo durante una fase de enfrentamiento.
\end{minipage}
...
\smallskip
\footnotesize (c) Segundo mundo con presencia del jefe y obstáculos de plataformas.
\end{minipage}
\hfill
\begin{minipage}{0.48\textwidth}
\centering
...
\smallskip
\footnotesize (d) Pantalla final Regreso a Casa, cierre narrativo del recorrido.
\end{minipage}
\caption{Evidencias avanzadas del prototipo: gafas activadas, primer jefe, segundo mundo y cierre narrativo.}
\label{fig:evidencias-avanzadas}
\end{figure*}

\FloatBarrier

\subsection{Prueba de Usabilidad}
Para dejar documentado el proceso de evaluación, se planteó una prueba piloto de usabilidad con cinco perfiles de usuario y tareas representativas, tomando como referencia trabajos recientes que evalúan la usabilidad de videojuegos serios sobre bullying y cyberbullying \cite{martel2025}. Cada participante debe jugar el prototipo y completar las tareas de la Tabla \ref{tab:tareas-usabilidad}
...
En la evaluación, tres de los cinco perfiles completaron las seis tareas y dos completaron cinco de seis, por lo que la tasa general de finalización fue de 93.3\%. Las tareas con mejor desempeño fueron iniciar partida, consultar controles, modificar opciones y resolver el puzzle base. Las mayores dificultades aparecieron en el uso oportuno de las gafas, el parkour con sprint y la orientación dentro del segundo mundo.

La dificultad promedio fue de 2.8 sobre 5. Los perfiles reportaron que la pantalla de controles y los mensajes del HUD ayudaban a comprender la ruta, pero también evidenciaron que algunos textos podían desaparecer rápido durante momentos de presión. Como mejora posterior, se recomienda reforzar los mensajes relacionados con la activación de gafas, mantener señales visuales claras en zonas de parkour y conservar checkpoints frecuentes antes de retos exigentes. En términos generales, la prueba indica que el prototipo es comprensible y jugable, aunque requiere pulido de balance en secciones de alta dificultad.
...
\bibitem{olsson2022}
T. Olsson, S. Sentilles, and E. Papatheocharous, ``A systematic literature review of empirical research on quality requirements,'' \textit{Requirements Engineering}, vol. 27, pp. 249--271, 2022, doi: 10.1007/s00766-022-00373-9.

\bibitem{godotdocs}
Godot Engine, ``GDScript reference,'' Official documentation, 2026. [Online]. Available: \url{https://docs.godotengine.org/en/stable/tutorials/scripting/gdscript/gdscript_basics.html}

\bibitem{godotsignals}
Godot Engine, ``Using signals,'' Official documentation, 2026. [Online]. Available: \url{https://docs.godotengine.org/en/stable/getting_started/step_by_step/signals.html}

\bibitem{godotinput}
Godot Engine, ``Using InputEvent,'' Official documentation, 2026. [Online]. Available: \url{https://docs.godotengine.org/en/stable/tutorials/inputs/inputevent.html}
